...
import pandas as pd
import os
from cyc_PlotAndFit import plot_and_fit_mutiple
from cyc_PlotAndFit import plot_and_fit_mutiplev2
from cyc_PlotAndFit import plot_and_fit_mutiple_cutoff
...
filesToSearch = arrayCyclicParameterID
...
plot_and_fit_mutiple(arrayPath)
